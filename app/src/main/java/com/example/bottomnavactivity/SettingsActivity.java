...
import com.example.bottomnavactivity.Services.ProductoService;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productoAdapter.setOnCambioCallback(() -> {
            if (!updatingResumen) {
        ...
        productoService = client.BuildRetrofitClient().create(ProductoService.class);
    ...
    private void processBarcodeResult(String barcode) {
        ...
        productoService.getProductoPorCodigo(barcode).enqueue(new Callback<ProductoDTO>() {
            @Override
    ...
    private void enviarSiguienteDetalle(String ventaId, int index) {
        ...
        int cantidad = productoAdapter.getCantidadProducto(producto.getProductoId());
    ...
    private void actualizarResumen() {
        BigDecimal total = productoAdapter.calcularTotal();
